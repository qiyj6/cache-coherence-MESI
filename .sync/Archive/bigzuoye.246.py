...
def decode_address(op_address_n):
    ...
    op_address_n_str=op_address_n_str[2:].rjust(12,'0')     #左侧用0补齐至32位
...
for i in range(max(len(op_1),len(op_0))):
    ...
    if(cache_0_hit!=-1):
        cache_0,cache_1=cache_op_hit(cache_0,cache_1,mem_list,index_0,tag_0,cache_0_hit,op_0[i],offset_0)
    else:
        cache_0,cache_1=cache_op_miss(cache_0,cache_1,mem_list,index_0,tag_0,op_0[i],offset_0)
        
    if(cache_1_hit!=-1):
        cache_1,cache_0=cache_op_hit(cache_1,cache_0,mem_list,index_1,tag_1,cache_1_hit,op_1[i],offset_1)
    else:
        cache_1,cache_0=cache_op_miss(cache_1,cache_0,mem_list,index_1,tag_1,op_1[i],offset_1)
