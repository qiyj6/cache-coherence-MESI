...
def read_from_bus(cache_op_d,cache_op_id,mem_list,tag,index,offset_in_set_d,bus):
    bus.occuied(bus,tag=tag,index=index,broadcast=0,device_id=the_other_cache_id)
