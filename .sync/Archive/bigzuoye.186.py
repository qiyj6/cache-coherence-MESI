...
def read_from_bus(cache_op_d,cache_op_id,mem_list,tag,index,offset_in_set_d,bus_0=bus()):
    bus_0=bus_0.occuied(tag=tag,index=index,broadcast=0,device_id=the_other_cache_id)
    if(bus_0.broadcast==0 and bus.device_id==the_other_cache_id):
