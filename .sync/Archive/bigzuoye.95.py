...
class cache_line:
    ...
    def print_cache_line(self):
        print("tag : ", self.tag, ", state: ", self.state, ", data: ", self.data)
...
for i in range(max(len(op_1),len(op_0))):
    ...
    print('第%d次cache_0操作前状态'%(i+1),cache_0[index_0][0].state)
    print('第%d次cache_1操作前状态'%(i+1),cache_1[index_1][0].state,'\n')
    ...
    print('第%d次cache_0状态'%(i+1),cache_0[index_0][0].state)
    print('第%d次cache_1状态'%(i+1),cache_1[index_1][0].state)
    print('第%d次cache_0tag'%(i+1),cache_0[index_0][0].tag)
    print('第%d次cache_0tag'%(i+1),cache_1[index_1][0].tag,'\n')
